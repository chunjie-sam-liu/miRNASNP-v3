...
json_path="/home/fux/fux/miRNASNP3/predict_result/mutation_altutr/cosmic_tgs_chr_suply_json/"
bed_path="/home/fux/fux/miRNASNP3/predict_result/mutation_altutr/cosmic_tgs_chr_suply_bed/"
in_path="/home/fux/fux/miRNASNP3/predict_result/mutation_altutr/cosmic_tgs_chr/"

f=sys.argv[1]
#fi=f.split('.')[0]

with open(json_path+f+".json","a") as jsonout:
    temp_json={}
    with open(bed_path+f+".bed","a") as bedout:
